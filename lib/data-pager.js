 ...
 *
 * @arguments {String} name Name of the internal value
 * @argumnets {Number} value Value to set, must be an integer
...
Pager.prototype = {
    ...
    /**
     * List n previous pages before this page, up to the first page
     *
    ...
    /**
     * List n previous pages after this page, up to the last page
     *
     * @argument {Number} n Number of pages to list
     * @returns {Array} pages Array with page numbers
     */
    nextPages: function(n) {
        ...
        for (var i = page + 1; i < last && i < n + page + 1; i++) {
            pages.push(i);
        }
